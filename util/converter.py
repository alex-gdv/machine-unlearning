...
def rgb_converter(root_dir, save_dir):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir", required=True, help="directory containing images to RGB convert")
    parser.add_argument("--save_dir", required=True, help="directory to save RGB converted images")
    args = parser.parse_args()

    assert os.path.isdir(args.root_dir), "root directory does not exist"
